...
async def entrypoint(ctx: JobContext) -> None:
    ...
    async def emit_audio(chunk: AudioChunk) -> None:
        ...
        try:
            ...
            # LiveKit room disconnected or track invalidated mid-stream.
            # Raise CancelledError so the generation task exits cleanly
            # without attempting a fallback reply on a dead connection.
