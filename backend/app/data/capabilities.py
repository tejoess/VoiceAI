...
CAPABILITIES: dict[str, dict] = {
    ...
    "multilingual": {
        ...
        "status": "available",
        "prompt": (
            "LANGUAGE SWITCHING: You can speak in multiple languages. "
            "Listen carefully to what language the caller uses and respond in the same language. "
            "If the caller explicitly asks to switch languages (e.g. 'speak in Hindi', "
            "'please talk in English', 'हिंदी में बात करें'), switch immediately and continue "
            "the rest of the conversation in that language. "
            "Never refuse a language switch. Do not mention that you are switching — just do it naturally."
        ),
        "tools": [],
    },
    "crm": {
