...
async def create_all() -> None:
    ...
    async with engine.begin() as conn:
        ...
        # Idempotent ADD COLUMN migrations — PostgreSQL supports IF NOT EXISTS.
        # Silently ignored on fresh databases where create_all already built the column.
        migrations = [
            "ALTER TABLE agents ADD COLUMN IF NOT EXISTS stt_provider VARCHAR(20) NOT NULL DEFAULT 'deepgram'",
        ]
