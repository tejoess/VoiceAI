...
_RAG_SCHEMA: dict = {
    ...
    "function": {
        ...
        "description": (
            "Search uploaded documents for information relevant to the caller's question. "
            "IMPORTANT: Before calling this tool you MUST first say a brief spoken "
            "acknowledgment such as 'Let me check that for you.' or 'Sure, just a moment.' "
            "so the caller hears something immediately. Then call this tool with a concise query."
        ),
        "parameters": {
            "type": "object",
            "properties": {
